...
public class EnemyPatrol : MonoBehaviour
{
    ...
    private void UpdateTarget()
    {
        ...
        // If wee are in the left, change target to the right
        ...
        // If wee are in the right, change target to the left
    ...
    IEnumerator PatrolToTarget()
    {
        ...
        // At this point, the obk=ject reached thee target, let's set our position to the target's one
